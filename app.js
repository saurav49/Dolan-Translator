...
const getTranslation = async (textToTranslate) => {
    let response = await fetch(`https://api.funtranslations.com/translate/dolan.json?text=${textToTranslate}`);
...
// https://api.funtranslations.com/translate/dolan.json  api call